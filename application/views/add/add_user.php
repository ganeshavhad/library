                  ...
                  'class' => 'form-horizontal form-label-left', 
                    ...
                    <div class="item form-group">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12"  name="userdob" placeholder="" required="required" type="date">
                        </div>
                      </div>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" name="username" onkeypress="return RestrictSpace()" class="form-control col-md-7 col-xs-12"  required="required" type="text">
                        </div>
                      </div>
