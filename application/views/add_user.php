            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                  <?php echo form_open_multipart('User/add', array(
                  'class' => 'form-horizontal form-label-left', 
                    ...
                    <div class="item form-group">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  class="form-control col-md-7 col-xs-12"  name="userdob" placeholder="" required="required" type="date">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number"  max="9999999999" name="rolecontact" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                    <!--                        
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="file" name="Studentimage" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div> -->
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="usernameid"  name="username" onkeypress="return RestrictSpace()" class="form-control col-md-7 col-xs-12"  required="required" type="text">
                          <p id="param" style="font-size=1px;margin-left:15px;margin-top:0px;margin-bottom:0px;"></p>
                        </div>
                      </div>
                       ...
                       <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="password" type="password" onkeypress="return RestrictSpace()" name="password" data-validate-length="6" class="form-control col-md-7 col-xs-12" required="required">
                        </div>
                      </div>
                      <div class="item form-group">
              ...
              $.ajax({
                ...
                success: function (data) {  
                    ...
                    if(data==1){
                        ...
                        $("#param").html('<p style="color:red;font-size=1px;margin-top:0px;">username not available</p>');
                    }
                    else if(data==0){
                       $("#sub").removeAttr("disabled");
                        $("#param").html('<p style="color:green;font-size=1px;margin-top:0px;">username available</p>');
                    }
                },
